...
void simulation(unsigned int year,
	...
	const std::list<la::Vec2d>& vec_lose_list)
{
	...
	std::string ofs_win_name = std::string("win_info_") + std::to_string(year) + std::string(".dat");
	std::string ofs_lose_name = std::string("lose_info_") + std::to_string(year) + std::string(".dat");
	...
	}
	{
		...
		std::string ofs_name = std::string("money_") + std::to_string(year) + std::string(".dat");
	...
	{
		std::string ofs_name = std::string("pay_") + std::to_string(year) + std::string(".dat");
		std::ofstream ofs(ofs_name.c_str());
		unsigned int i = 0;
	...
	{
		std::string ofs_name = std::string("win_") + std::to_string(year) + std::string(".dat");
		std::ofstream ofs(ofs_name.c_str());
		unsigned int i = 0;
	...
	{
		std::string ofs_name = std::string("biggest_win_") + std::to_string(year) + std::string(".dat");
		std::ofstream ofs(ofs_name.c_str());
...
int main(){
	...
	{ // simulation
		for(unsigned int year = 2007; year < 2016; ++ year){
			simulation(year, vec_win_list, vec_lose_list);
		}
